...
#include "UTHUDWidget_MultiTeamClock.h"

UUTHUDWidget_MultiTeamClock::UUTHUDWidget_MultiTeamClock(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	...
	static ConstructorHelpers::FObjectFinder<UTexture2D> Tex0(TEXT("Texture2D'/MultiTeamGame/MultiTeamGameContent/Textures/RedTeamSymbol.RedTeamSymbol'"));
	static ConstructorHelpers::FObjectFinder<UTexture2D> Tex1(TEXT("Texture2D'/MultiTeamGame/MultiTeamGameContent/Textures/BlueTeamSymbol.BlueTeamSymbol'"));
	static ConstructorHelpers::FObjectFinder<UTexture2D> Tex2(TEXT("Texture2D'/MultiTeamGame/MultiTeamGameContent/Textures/GreenTeamSymbol.GreenTeamSymbol'"));
	static ConstructorHelpers::FObjectFinder<UTexture2D> Tex3(TEXT("Texture2D'/MultiTeamGame/MultiTeamGameContent/Textures/GoldTeamSymbol.GoldTeamSymbol'"));
	MultiTeamIcon.Insert(Tex0.Object, 0);
	MultiTeamIcon.Insert(Tex1.Object, 1);
	MultiTeamIcon.Insert(Tex2.Object, 2);
	MultiTeamIcon.Insert(Tex3.Object, 3);

	BackgroundSlate.Atlas = MTAtlas;
	...
	BackgroundBorder.Atlas = MTAtlas;
	...
	RedTeamLogo.Atlas = MultiTeamIcon[0];
	...
	BlueTeamLogo.Atlas = MultiTeamIcon[1];
	...
	GreenTeamLogo.Atlas = MultiTeamIcon[2];
	...
	GoldTeamLogo.Atlas = MultiTeamIcon[3];
...
void UUTHUDWidget_MultiTeamClock::InitializeWidget(AUTHUD* Hud)
{
	Super::InitializeWidget(Hud);

	RedScoreText.GetTextDelegate.BindUObject(this, &UUTHUDWidget_MultiTeamClock::GetRedScoreText);
	BlueScoreText.GetTextDelegate.BindUObject(this, &UUTHUDWidget_MultiTeamClock::GetBlueScoreText);

	GreenScoreText.GetTextDelegate.BindUObject(this, &UUTHUDWidget_MultiTeamClock::GetGreenScoreText);
	GoldScoreText.GetTextDelegate.BindUObject(this, &UUTHUDWidget_MultiTeamClock::GetGoldScoreText);

	ClockText.GetTextDelegate.BindUObject(this, &UUTHUDWidget_MultiTeamClock::GetClockText);
}

void UUTHUDWidget_MultiTeamClock::Draw_Implementation(float DeltaTime)
{
...
FText UUTHUDWidget_MultiTeamClock::GetRedScoreText_Implementation()
{
...
FText UUTHUDWidget_MultiTeamClock::GetBlueScoreText_Implementation()
{
...
FText UUTHUDWidget_MultiTeamClock::GetClockText_Implementation()
{
	...
	ClockText.TextScale = (RemainingTime >= 3600) ? AltClockScale : GetClass()->GetDefaultObject<UUTHUDWidget_MultiTeamClock>()->ClockText.TextScale;
	return ClockString;
}

FText UUTHUDWidget_MultiTeamClock::GetGreenScoreText_Implementation()
{
...
FText UUTHUDWidget_MultiTeamClock::GetGoldScoreText_Implementation()
{
